...
print(Fore.BLUE + "===============Start searching============")
print(Fore.BLUE + "===============Start searching============")
print(Fore.BLUE + "===============Start searching============")
print(Fore.BLUE + "===============Start searching============")
...
def seek(r):
	...
	i = 0
	print(Fore.GREEN + "Core " + str(r) +":  Searching Private Key..")
	while True:
		i=i+1
		...
		with open(filename) as f:
			for line in f:
				if pub in line:
					...
					f.close()
					time.sleep(30)
					print (Fore.RED + 'WINNER WINNER CHICKEN DINNER!!! ---- ' +datetime.now().strftime('%Y-%m-%d %H:%M:%S'), pub, priv)
					break
